...
骨架的每一层对应知识体系的一层,知识体系有几层,骨架就有几层:
...
三个体系都止于三层。再往下——CS2023 的 topic、SWEBOK 的 subtopic——没有稳定编号、粒度不一、改版时变动大,没有权威结构可借。骨架的定义就是「从知识体系借来的部分」,所以到此为止。Z39.19 §11.1.7 从成本一面支持这个界线:边缘领域的细词让词表难管理,人工建关系的成本高;骨架越深,空节点越多。
