...
| Application Profile | [Application Profile](../concepts/application-profile.md) | [DCMI Application Profiles 阅读笔记](../sources/dcmi-application-profiles.md)；[Obsidian 官方帮助阅读笔记](../sources/obsidian-help.md) | 从 metadata／应用需求导出捕获、内容使用、导航、诊断和反馈的功能范围，以及模型引用、字段约束、使用指南和 encoding；不产生 DCAP conformance |
