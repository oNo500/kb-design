...
from kb_core.apply_source_migration import ApplyResult, apply_migration
from kb_core.plan_source_migration import build_migration_plan
...
class SourceMigrationTests(unittest.TestCase):
    ...
    def test_apply_rejects_output_inside_formal_root(self):
        with self.assertRaises(ValueError):
            apply_migration(ROOT, BLOCKED_PLAN, ROOT / "data" / "vocab")
