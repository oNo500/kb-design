...
from scripts import export_obsidian as exporter
...
class LabelBasisExportTests(unittest.TestCase):
    def setUp(self):
        document = yaml.safe_load((ROOT / "vocab/topics.yaml").read_text())
    ...
    def test_model_basis_is_readable_without_becoming_an_external_source(self):
        exporter._validate_record("topics", "vocab/topics.yaml", "concepts", self.record)
