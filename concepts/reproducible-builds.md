...
- [Reproducible Builds 阅读笔记](../sources/reproducible-builds.md)：定义、环境输入和当前项目边界
...
- [BagIt 文件包格式阅读笔记](../sources/rfc-8493.md)：manifest、checksum、complete bag 与 valid bag 的边界
- [RFC 8785 阅读笔记](../sources/rfc-8785.md)：JCS 的组合条件与当前参数边界
- [W3C PROV 阅读笔记](../sources/w3c-prov.md)：provenance 对象、关系和证明边界
- [Python 文件系统阅读笔记](../sources/python-filesystem.md)：原子可见性、持久性与事务边界
