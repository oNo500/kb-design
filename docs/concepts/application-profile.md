...
- [DCMI Application Profiles 阅读笔记](../references/dcmi-application-profiles.md)：材料身份、职责边界、规范状态、译名结论和项目边界
...
- [Obsidian 官方帮助阅读笔记](../references/obsidian-help.md)：properties、YAML 和应用能力边界
