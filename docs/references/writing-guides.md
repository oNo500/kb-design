...
读了六份写作规范，按“原则 → 中文书面语 → 技术写作 → 文档分类”四层提炼可用规则，每条标原始出处。目的是给概念文“写作规范”和 `docs/design/governance/writing.md` 提供依据。
...
对本库的映射：`docs/concepts/` 解释，`docs/design/` 参考（定义段允许解释），`docs/references/` 参考。
...
| `docs/design/model/topics.md` 同时解释和规定 | 四类不混 | 相关 |
