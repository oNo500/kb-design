...
- [证据阶段决定](../../../design/decisions/evidence-stage-boundary.md)把必要但取证昂贵的真实语义结论和严格切换放入下一阶段；当前阶段继续完成工具、账本、义务、候选、交付和回滚能力。低价值旧断言研究审计关闭，不进入下一阶段。当前阶段完成不得表述为草案生效、严格切换或发版。
