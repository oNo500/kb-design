...
状态：实现与验收完成。原盘点基线为 `633f684`；字段合同及缺值规则已由后续决定承接，最终以[来源收尾决定](../../docs/decisions/source-completion.md)和[迁移验收](../reviews/2026-09-06-source-v2-acceptance.md)为准。正文保留方案形成时的选项与边界，不把旧的待采纳措辞当作当前未执行任务。正式知识库不在本次写集。
